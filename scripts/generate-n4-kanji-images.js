...
async function main() {
  console.log('\n🎨 Starting N4 Kanji Image Generation\n');
  ...
  // Fetch N4 kanji from Supabase
  console.log('📥 Fetching N4 kanji from database...');
  ...
  console.log(`✓ Found ${kanjiList.length} N4 kanji\n`);
  ...
  for (let i = 0; i < kanjiList.length; i++) {
    ...
    // Create descriptive filename: kanji-水-mizu-water-stroke-order.png
