        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            >
              ...
              {/* Mega Menu Dropdown */}
              {isResourcesOpen && (
                <div className="fixed top-[4rem] left-1/2 -translate-x-1/2 w-[1000px] max-w-[calc(100vw-2rem)] bg-white rounded-lg shadow-xl border border-gray-200 p-6 z-50">
            ...
            >
              ...
              {/* Mega Menu Dropdown */}
              {isToolsOpen && (
                <div className="fixed top-[4rem] left-1/2 -translate-x-1/2 w-[800px] max-w-[calc(100vw-2rem)] bg-white rounded-lg shadow-xl border border-gray-200 p-6 z-50">
