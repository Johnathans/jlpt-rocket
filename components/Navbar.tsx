      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-6">
            <Link 
              href="/sentences" 
              className="text-gray-700 hover:text-pink-500 font-medium transition-colors px-3 py-2 rounded-md hover:bg-gray-50"
            >
              Sentences
            </Link>
            <Link 
            ...
            <button className="px-6 py-2 bg-pink-500 text-white hover:bg-pink-600 font-medium transition-colors rounded-md shadow-sm">
              Sign Up
            </button>
          </div>
        ...
        {isOpen && (
          <div className="md:hidden pb-4 space-y-2">
            <Link 
              href="/sentences" 
              className="block px-4 py-3 text-gray-700 hover:text-pink-500 hover:bg-gray-50 font-medium transition-colors rounded-md mx-2"
            ...
            <div className="px-6 pt-4 space-y-3">
              ...
              <button className="w-full px-4 py-2 bg-pink-500 text-white hover:bg-pink-600 font-medium transition-colors rounded-md shadow-sm">
                Sign Up
              </button>
            </div>
          </div>
