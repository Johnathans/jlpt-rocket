...
import { getKanjiByLevel, getVocabularyByLevel, JLPTLevel } from '@/lib/static-data';
            ...
            {!isFlipped ? (
              ...
              <div className="w-full flex flex-col items-center justify-center" style={{ minHeight: '400px' }}>
                <div className="text-center">
                  ...
                  <div className="text-8xl sm:text-9xl md:text-[10rem] font-bold font-japanese text-gray-400 dark:text-gray-600 mb-6">
                    {currentItem.character}
                  </div>
                  {currentItem.reading && (
