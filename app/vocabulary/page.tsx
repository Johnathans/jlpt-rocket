...
function VocabularyPageContent() {
  ...
  return (
    <div className="min-h-screen pb-20 bg-gray-50 dark:bg-gray-900">
      {/* Sticky header bar */}
      <div className="sticky top-0 z-50 bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            ...
            <div className="flex gap-2 sm:gap-3">
              <button
                onClick={selectAll}
                className="flex-1 sm:flex-none px-4 sm:px-6 py-2 sm:py-3 bg-white dark:bg-gray-800 text-pink-600 dark:text-pink-400 hover:bg-pink-50 dark:hover:bg-pink-900/20 font-medium transition-colors rounded-md shadow-sm border-b-4 border-pink-300 hover:border-pink-400 text-sm sm:text-base"
              >
                Select All
              </button>
              <button
                onClick={clearAll}
                className="flex-1 sm:flex-none px-4 sm:px-6 py-2 sm:py-3 bg-gray-400 dark:bg-gray-600 text-white hover:bg-gray-500 dark:hover:bg-gray-500 font-medium transition-colors rounded-md shadow-sm border-b-4 border-gray-600 dark:border-gray-700 hover:border-gray-700 text-sm sm:text-base"
              >
                Clear All
              </button>
            </div>
